...
const steps = [
  ...
  {
    id: 2,
    question: "링크를 클릭하니, 회사 로그인 화면과 매우 유사한 페이지가 열렸습니다. 주소창에는 https가 붙어 있지만 도메인은 실제 회사 도메인과 조금 다릅니다. 어떤 행동을 할까요?",
  ...
  {
    id: 4,
    question: "메일을 삭제하고 IT 보안팀에 신고했습니다. 하지만 혹시라도 클릭했을 가능성이 있어 걱정됩니다. 다음으로 무엇을 하시겠습니까?",
  ...
  },
  {
    ...
    result: {
      ...
      description: "• 악성 링크를 클릭했거나 취약점이 있을 경우 자동 감염 위험이 있습니다.\n• 최신 백신으로 전체 검사를 시행하세요.\n• 로그 분석 및 이상 징후 확인도 병행해야 합니다.",
  ...
  },
  {
    ...
    result: {
      ...
      description: "• 비밀번호 변경과 이중 인증은 매우 효과적인 보안 조치입니다.\n• 가능한 모든 계정에 2FA를 적용하고, 백업 코드는 안전하게 보관하세요.\n• 로그인 알림 활성화도 추천됩니다.",
      imageUrl: "https://cdn-icons-png.flaticon.com/512/190/190411.png",
    },
  },
  {
  ...
  },
  {
    ...
    result: {
      ...
      description: "• 의심 도메인을 차단함으로써 재접속을 막을 수 있습니다.\n• 그래도 피싱 시도에 노출되었을 수 있으므로:\n  1) 백신 검사\n  2) 비밀번호 변경\n  3) 2FA 설정을 반드시 수행하세요.",
      imageUrl: "https://cdn-icons-png.flaticon.com/512/190/190411.png",
    },
  },
];
